...
class MiniMaxH3Extender:
    ...
    def INPUT_TYPES(cls):
        ...
        # stable slots.
        optional = {
            "initial_context": ("LATENT", {"tooltip": "Encoded source AV tail for the first Ref2VA Motion Context clip."}),
            "sigmas": ("SIGMAS", {"tooltip": "Optional exact sampling schedule, e.g. HyperFlow. Overrides steps, scheduler and denoise; sampler_name still applies. Validated clips remain cached."}),
            "fl2va_model": (
                "MODEL",
                {
                    "forceInput": True,
...
if getattr(PromptServer, "instance", None) is not None:
    @PromptServer.instance.routes.post("/director_plus/extender/project/new")
    ...
    @PromptServer.instance.routes.get("/director_plus/extender/loras")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/ref/upload")
    ...
    @PromptServer.instance.routes.get("/director_plus/extender/local_media/{media_id}")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/local_media/upload")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/ref/edit")
    ...
    @PromptServer.instance.routes.get("/director_plus/extender/ref/image")
    ...
    @PromptServer.instance.routes.get("/director_plus/extender/fl2va/continuity_meta")
    ...
    @PromptServer.instance.routes.get("/director_plus/extender/fl2va/last_frame")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/project/prepare_save")
    ...
    @PromptServer.instance.routes.get("/director_plus/extender/project/download")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/project/load")
