...
_CACHE_ROOT = Path(folder_paths.get_user_directory()) / "director_plus" / "cache"
...
if web is not None and PromptServer is not None and getattr(PromptServer, "instance", None) is not None:
    @PromptServer.instance.routes.post("/director_plus/extender/full_batch_interrupt")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/bootstrap_ref2va_motion_cache")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/local_ref_invalidate")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/discard_computed")
    ...
    @PromptServer.instance.routes.get("/director_plus/extender/color_editor_info")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/color_adjust")
    ...
    @PromptServer.instance.routes.post("/director_plus/extender/save_preview")
    ...
    @PromptServer.instance.routes.get("/director_plus/extender/cache_state")
    ...
    @PromptServer.instance.routes.get("/director_plus/extender/restored_preview")
